  ...
  <Card className={`span-12 ${ props.className }`}>
      ...
      <div className="header_text">
        <h1>{props.article.title}
          ...
          <a href={`https://www.facebook.com/sharer/sharer.php?u=amherststudent.com/article/${props.article.slug}`}><Icon size={32} icon={socialFacebookCircular}/></a>
          <a href={`https://twitter.com/intent/tweet?url=amherststudent.com/article/${props.article.slug}&text=${props.article.excerpt}`}><Icon size={32} icon={socialTwitterCircular}/></a>
        </h1>
