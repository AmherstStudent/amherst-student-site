...
const Article_Header = props => (
  <Card className={`span-12 ${props.className}`}>
    <span className="category_name">{props.article.category.name.toUpperCase()}</span>
    <div className="header_text">
      <h1>
        ...
        <a
          href={`https://www.facebook.com/sharer/sharer.php?u=http://amherststudent.com/article/${props.article.slug}`}
        >
          <Icon size={32} icon={socialFacebookCircular} />
        </a>
        <a
          href={`https://twitter.com/intent/tweet?url=http://amherststudent.com/article/${props.article.slug}&text=${
    ...
    <div className="article_details">
      <h5>
        ...
        {moment(props.article.updatedAt)
          .format('MMMM D YYYY')
          .toUpperCase()}
      </h5>
    </div>
