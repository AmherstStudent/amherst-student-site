...
const Article_Header = (props) => (
  <Card className={`span-12 ${ props.className }`}>
      ...
      By {props.article.author.username}, {props.article.author.reporterTitle} | {moment(props.article.updatedAt).format('MMMM D YYYY').toUpperCase()} | {props.article.issue.name}
      </h5>
  <style jsx>{`
