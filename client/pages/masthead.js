      ...
      <div className="card" id="masthead">
        ...
        <div className="cardContent">
          <p>
            ...
            year, with the exception of vacations and exam periods, and is distributed to members of
            the college and the communities of Amherst, Hadley and the Five College area free of
            charge, as well as to alumni and parents by subscription.{' '}
          </p>
          <p>
          ...
          <p>
            ...
            newspaper. If you are interested in writing for a section of The Student, please contact
            the appropriate managing editor(s). If you are interested in the publishing and business
    ...
    <div className="card" id="masty">
      ...
      <div className="card" id="ad">
        ...
        <div className="cardContent">
          ...
          <p>
            The Student publishes on Wednesdays during the school year. For the Fall 2018 semester,
            we will publish on:
          </p>
          <ul>
      ...
      <div className="card">
        ...
        <div className="cardContent">
          <p>
            ...
            get every issue of your favorite (and only) Amherst College newspaper! Please send a
            check to The Amherst Student, AC#2291, Amherst College, Amherst, MA 01002, P.O. Box
            5000, or email us at astudent@amherst.edu to inquire about subscriptions.
          </p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="cardContent">
          <p>
            ...
            considerations for space or content. Letters must bear the names of all contributors and
            a phone number where the author or authors may be reached. Letters and columns may be
            edited for clarity and The Student’s style. The Student will not print personal or group
            defamation.
          </p>
        </div>
      </div>
